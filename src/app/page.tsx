...
function Pricing() {
  return (
    <section id="pricing" className="mx-auto max-w-6xl px-5 py-20">
      <SectionHeader
        eyebrow="Pricing"
        title="One report. One price. Pay only if it&rsquo;s useful."
        body="Generate a free preview to see your personalised situation summary and primary scoring. Unlock the full Blueprint when you&rsquo;re ready."
      />
      <div className="mt-10 grid md:grid-cols-2 gap-5 max-w-3xl mx-auto">
        {/* Free */}
        <div className="rounded-2xl bg-white border border-black/10 shadow-card p-6 md:p-7 flex flex-col">
          <div className="flex items-center justify-between">
            <div className="text-sm font-medium">Free Preview</div>
            <span className="text-xs rounded-full bg-canvas text-ink-muted px-2 py-0.5">No card required</span>
          </div>
          ...
          <ul className="mt-5 space-y-2 text-sm text-ink-muted flex-1">
            ...
            <li className="flex gap-2"><BulletCheck /><span>Generated by Claude in 2–4 minutes</span></li>
          </ul>
          <Link
            href="/start"
            className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-white border border-blueprint-500 text-blueprint-700 font-medium px-4 py-2.5 hover:bg-blueprint-50 transition"
          >
            Start free preview →
          </Link>
        </div>
        ...
        {/* Full */}
        <div className="rounded-2xl bg-ink text-white border border-ink shadow-card p-6 md:p-7 flex flex-col relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="mt-2 text-xs text-white/60">Everything in Free Preview, plus:</p>
            <ul className="mt-5 space-y-2 text-sm text-white/80 flex-1">
              <li className="flex gap-2"><BulletCheckGold /><span>Full situation summary (4 paragraphs of analysis)</span></li>
              <li className="flex gap-2"><BulletCheckGold /><span>All 8+ structures scored &amp; explained with notes</span></li>
              <li className="flex gap-2"><BulletCheckGold /><span>Named primary &amp; secondary recommendations</span></li>
              <li className="flex gap-2"><BulletCheckGold /><span>Full exit narrative — Division 152 verdict, after-tax proceeds, post-2027 impact</span></li>
              <li className="flex gap-2"><BulletCheckGold /><span>Complete irreversibility map (8 decisions, time-sequenced)</span></li>
              <li className="flex gap-2"><BulletCheckGold /><span>Action checklist + 2026–27 Budget impact</span></li>
              <li className="flex gap-2"><BulletCheckGold /><span>International structure analysis (where relevant)</span></li>
              <li className="flex gap-2"><BulletCheckGold /><span>Accountant Brief — ready to hand to your tax agent</span></li>
            </ul>
            <Link
              href="/start"
              className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-gold-500 text-ink font-medium px-4 py-2.5 hover:bg-gold-400 transition"
            >
              Start &amp; unlock the full report →
            </Link>
            <p className="mt-3 text-[10px] text-white/40 text-center">
              Generate the free preview first, then upgrade securely via Stripe. 100% money-back if the report doesn&rsquo;t apply to you.
            </p>
          </div>
        </div>
      </div>
      <p className="mt-6 text-xs text-ink-muted text-center">
        Practice Edition (white-label for accountants) — <Link href="#practice" className="text-blueprint-600 hover:underline">register interest below</Link>.
      </p>
    </section>
  );
}
